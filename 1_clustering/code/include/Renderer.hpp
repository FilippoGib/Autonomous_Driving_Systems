...
namespace lidar_obstacle_detection
{
  ...
  public:
    ...
    void RenderBox(const Box& box, int id, Eigen::Vector3f box_center, double distance, const Color& color = Color(1,1,0), float opacity = 1.0);

    void RenderBox(const BoxQ& box, int id, const Color& color = Color(1,1,0), float opacity = 1.0);
